    ...
    <div className="max-w-4xl mx-auto space-y-8 pb-12">
      ...
      <div className="bg-white rounded-[2rem] border border-gray-100 shadow-sm overflow-hidden">
        ...
        <div className="px-8 pb-8 relative">
          <div className="absolute -top-12 left-8 w-24 h-24 rounded-3xl border-4 border-white bg-gray-100 overflow-hidden shadow-lg">
          ...
          <div className="pt-16 flex flex-col md:flex-row md:items-center justify-between gap-6">
            <div>
              <h2 className="text-2xl font-black text-gray-900">{user?.name || 'John Doe'}</h2>
              <p className="text-gray-500 font-medium">{user?.email || 'john@example.com'}</p>
            </div>
            <button 
              onClick={() => setIsEditModalOpen(true)}
              className="px-6 py-2.5 bg-indigo-600 text-white rounded-xl font-bold text-sm hover:bg-indigo-700 transition-all shadow-lg shadow-indigo-600/20"
            >
              Edit Profile
            </button>
          </div>
        ...
        <div className="bg-white p-8 rounded-[2rem] border border-gray-100 shadow-sm">
          ...
          <div className="space-y-4">
            <button 
              ...
              className="w-full flex items-center justify-between p-4 rounded-xl border border-gray-50 hover:bg-gray-50 transition-all"
            >
        ...
        {isEditModalOpen && (
          <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
            ...
            >
              ...
              <h3 className="text-2xl font-black text-gray-900 mb-2">Edit Profile</h3>
              <p className="text-gray-500 text-sm font-medium mb-8">Update your personal identification.</p>
              ...
              <form onSubmit={handleUpdateProfile} className="space-y-6">
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    ...
                    <input 
                      ...
                      className="w-full pl-12 pr-4 py-4 bg-gray-50 border border-gray-100 rounded-2xl focus:outline-none focus:ring-4 focus:ring-indigo-500/10 focus:bg-white focus:border-indigo-500 transition-all font-bold text-gray-900"
                    />
                  </div>
                </div>
                ...
                <button 
                  type="submit"
                  disabled={isLoading}
                  className="w-full py-4 bg-indigo-600 text-white rounded-2xl font-black text-lg shadow-xl shadow-indigo-600/20 hover:bg-indigo-700 transition-all flex items-center justify-center gap-2"
                >
        ...
        {isPasswordModalOpen && (
          <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
            ...
            >
              ...
              <p className="text-gray-500 text-sm font-medium mb-8">Secure your account with a new password.</p>
